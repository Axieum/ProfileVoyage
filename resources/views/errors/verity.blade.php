...
@section('content')
    <div id="app" class="container has-text-centered">
        ...
        <a href="{{ route('auth.sendverityemail') }}" class="button is-light" @click="resend" onclick="event.preventDefault(); document.getElementById('sendit').submit();">Resend Email</a>
