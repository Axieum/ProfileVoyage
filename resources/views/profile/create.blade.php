        ...
        <div class="columns">
            <div class="column is-8 is-offset-2">
                ...
                <form action="{{ route('profile.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        <div class="control has-icons-left has-icons-right">
                            <input v-model="location" type="text" class="input" :class="{'is-success': fields.location &amp;&amp; fields.location.valid, 'is-danger': errors.has('location')}" name="location" placeholder="Location" v-validate="'alpha_spaces|max:32'" value="{{ old('location') }}">
                            <span class="icon is-small is-left">
