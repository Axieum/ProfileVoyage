...
window.onload = function () {
    ...
    setTimeout(function () {
        var ele = document.getElementsByClassName('profile-info');
        ele[0].style.opacity = 1;
    }, 250);
    setTimeout(function () {
        var ele = document.getElementsByClassName('profile-divider');
    ...
    setTimeout(function () {
        ...
        var wrappers = document.getElementsByClassName('social-wrapper');
        for (var _i = 0; _i < wrappers.length; _i++) {
            var _cards = wrappers[_i].getElementsByClassName('card');
            for (var z = 0; z < _cards.length; z++) {
                sr.reveal(_cards[z], { reset: true, viewFactor: 0.2 }, 50);
            }
        }
    }, 1100);
